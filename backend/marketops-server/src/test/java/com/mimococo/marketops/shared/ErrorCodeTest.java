    ...
    void codeSetIsStable() {
        assertThat(ErrorCode.values())
                ...
                .containsExactly(
                        ...
                        "MAINTENANCE_LOOPBACK_REQUIRED", "OPERATOR_ATTRIBUTION_MISSING",
                        "CURRENCY_MISMATCH",
                        "AUTHENTICATION_REQUIRED", "MULTI_FACTOR_REQUIRED",
                        "STEP_UP_REQUIRED", "USER_NOT_PROVISIONED", "USER_INACTIVE",
                        "ACTION_NOT_PERMITTED", "RESOURCE_SCOPE_DENIED", "APPROVAL_EVIDENCE_SCOPE_BLOCKED",
                        ...
                        "GUARDRAIL_BLOCKED", "OUTCOME_POLICY_UNRESOLVED", "OUTCOME_POLICY_CONFLICTED",
                        "RECOMMENDATION_STALE", "APPROVAL_REQUIRED",
                        "COMMAND_STATE_INVALID", "WRITE_GATE_CLOSED", "READBACK_REQUIRED",
                        "COMPENSATION_UNSAFE", "POLICY_AUTHORIZATION_UNUSABLE",
                        "CAPABILITY_NOT_USABLE", "CONCURRENT_INTERVENTION", "OBJECT_STORAGE_VERIFICATION_FAILED",
                        "RAW_EVIDENCE_MISSING", "CALIBRATION_UNRESOLVED", "CALIBRATION_CONFLICTED",
                        "AFFECTED_SET_INCOMPLETE", "BINDING_INAPPLICABLE", "INDEPENDENCE_REQUIRED",
                        "ALLOWANCE_INSUFFICIENT", "SCOPE_CONTAINED", "LISTING_HEALTH_BLOCKS_LAUNCH",
                        "EXECUTION_PATH_MISMATCH", "RESTORE_UNSUPPORTED", "EVIDENCE_PATH_UNQUALIFIED",
                        "MATERIALITY_UNRESOLVED", "EXIT_REASON_NOT_APPROVED");
    }
}
