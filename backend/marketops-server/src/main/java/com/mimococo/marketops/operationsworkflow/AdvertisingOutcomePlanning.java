...
public interface AdvertisingOutcomePlanning {
    ...
    java.util.List<String> policyReasons(UUID organizationId, UUID candidateId, Instant at);
    java.util.List<String> manualPolicyReasons(UUID organizationId, UUID proposalId, Instant at);
