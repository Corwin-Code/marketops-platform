...
| OQ-102 | Actual API roles, subscriptions, quotas and write/readback semantics | EXTERNAL EVIDENCE REQUIRED for each account/capability | Corresponding real Adapter and Capability enablement | Marketplace Integration |
...
| OQ-108 | Hero SKU and first experiment/Pilot cohort | OPERATIONAL CONFIGURATION REQUIRED; use representative allowlist and avoid highest-blast-radius SKUs initially | Price Capability production enablement | Owner + Ops |
...
| OQ-111 | Initial Commercial Policy thresholds: minimum margin/profit, max delta, cooldown, Confidence and exceptions | OPERATIONAL CONFIGURATION REQUIRED and versioned in product | Price Pilot enablement; not implementation start | Owner + Ops + Finance |
