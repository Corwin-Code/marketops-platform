...
These checks inform frozen findings 009, 021 and 022. None is closed by this document. The local adapter, database and worker still require the corresponding fake-HTTP and isolated-database tests.
