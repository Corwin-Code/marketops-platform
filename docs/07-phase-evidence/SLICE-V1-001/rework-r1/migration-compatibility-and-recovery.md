...
The [28-file inventory](migration-inventory-132.json) records exact candidate and
...
[Full backend 131](full-backend-131/summary.json) includes standard PG17 clean
...
[Managed evidence 131](managed-profile-131/ARTIFACT-HASHES.json) includes PG17
