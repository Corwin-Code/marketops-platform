...
R=Path('/Users/chzhengx/Code/personal/marketops-platform'); O=Path('/tmp/slice3-publication-observation-e278b1e-r1'); assert not O.exists(); O.mkdir()
...
assert bi['memberCount']==2406 and bi['allCollectorEvidenceReferencesVerified'] is True and bi['zipCrcAndEveryMemberShaVerified'] is True and bi['allOriginalBytesUnchanged'] is True and bi['actualRawTestcaseCounts']=={'passed':2769,'failures':0,'errors':0,'skipped':0}
